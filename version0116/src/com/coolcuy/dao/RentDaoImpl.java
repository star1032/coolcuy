...
public class RentDaoImpl implements RentDao{
	...
	@Override
	public List<CarDto> getRentAbleCar(String spot, String type, String startDate, String endDate, Connection conn)
			throws SQLException {
		ResultSet rs = null;
		PreparedStatement pstmt = null;
		...
		String query = "SELECT * FROM CAR" +
				  " WHERE CARNUMBER" +
				    ...
				    " (SELECT CARNUMBER FROM RENT" +
				      " WHERE TO_DATE(?, 'yyyy-mm-dd HH24:MI') <= enddate AND" +
				      " TO_DATE(?, 'yyyy-mm-dd HH24:MI') >= startdate) AND TYPE=? AND SPOTNAME=?";
